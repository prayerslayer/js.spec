...
/**
 * Base class for Spec instances. Useful for implementing Specs.
 */
export abstract class AbstractSpec implements Spec {
  name: string;
  options: object;

  constructor(name: string, options: object);

  abstract conform(value: any): any;

  abstract explain(path: string[], via: string[], value: any): Problem[];
}
